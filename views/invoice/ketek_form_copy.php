        ...
        <tr>
            ...
            <td>
                ...
                $form->field($modelInvoice, 'dogovor_id')->widget(Select2::classname(), [
                    ...
                    'pluginEvents' => [
                        "select2:select" => new JsExpression('function() { console.log(\'sdfsdf\'); }'),

                        "select2:opening" =>  new JsExpression('function() { console.log(\'sdfsdf\'); }'),
                        "select2:open" => new JsExpression('function() { console.log(\'sdfsdf\'); }'),
                        "select2:closing" =>  new JsExpression('function() { console.log(\'sdfsdf\'); }'),
                        "select2:close" =>  new JsExpression('function() { console.log(\'sdfsdf\'); }'),
                        "select2:selecting" =>  new JsExpression('function() { console.log(\'sdfsdf\'); }'),
                        "select2:unselecting" => new JsExpression('function() { console.log(\'sdfsdf\'); }'),
                        "select2:unselect" =>  new JsExpression('function() { console.log(\'sdfsdf\'); }'),
                    ],
                ])->label('');
                ?>
            </td>
    ...
    <table align="center" cellpadding="0" cellspacing="0" class="table-products">
        ...
        <tr class="product-item-row">
            <td colspan="8">
                        ...
                        <tr class="product-item-row item">
                            ...
                            <td class="item-position">
                                ...
                                if (!$modelProductInvoice->isNewRecord) {
                                    echo Html::activeHiddenInput($modelProductInvoice, "[{$i}]pr_to_inv_id")->label('');
                                } ?>
                            ...
                            <td>
                                ...
                                <?= $form->field($modelProductInvoice, "[{$i}]item_number")->textInput(['maxlength' => true,'style' => ['width' => '50%', 'height' => '20px', 'font-size' => '12px']])->label('') ?>

                            </td>

                            <td class="">

                                <?= $form->field($modelProductInvoice, "[{$i}]pr_to_inv_id")->widget(Select2::classname(), [
                                 /* 'data' => ArrayHelper::map(\app\models\Products::find()->where(['active' => 'y'])->all(),
                                        'products_id', 'part_number'),*/
                                    'options' => [
                                        'placeholder' => 'Артикул',
                                    ...
                                    'pluginOptions' => [
                                        'maxlength' => true,
                                        'style' => ['width' => '80%', 'height' => '20px', 'font-size' => '12px'],


                                        'allowClear' => true,
                                        'minimumInputLength' => 1,
                                        /*'ajax' => [
                                            'url' => "/products/dropdown-for-invoice",
                                          //  Url::to(['products/dropdown-for-invoice']),
                                            'dataType' => 'json',
                                            'delay' => 250,
                            ...
                            <td class="">
                                ...
                                <?= $form->field($modelProductInvoice, "[{$i}]product_id")->widget(Select2::classname(), [
                                   /* 'data' => ArrayHelper::map(\app\models\Products::find()->where(['active' => 'y'])->all(),
                                        'products_id', 'part_number'),*/
                            ...
                            <td>
                                ...
                                <?= $form->field($modelProductInvoice, "[{$i}]quantity")->textInput(['maxlength' => true,'style' => ['width' => '50%', 'height' => '20px', 'font-size' => '12px']])->label('') ?>

                            </td>

                            <td>

                                <?= $form->field($modelProductInvoice, "[{$i}]unit_price_manual")->textInput(['maxlength' => true,'style' => ['width' => '50%', 'height' => '20px', 'font-size' => '12px']])->label('') ?>

                            </td>

                            <td>
                                <?= $form->field($modelProductInvoice, "[{$i}]total_price")->textInput(['maxlength' => true, 'style' => ['width' => '50%', 'height' => '20px', 'font-size' => '12px']])->label('') ?>
                ...
                <div class="panel-heading">
                    <!--                    <h3 class="panel-title pull-left panel-title-products"> </h3>
                    -->
                    <div class="pull-right">
                        <button type="button" class="add-product btn btn-success btn-xs"><i
                                class="glyphicon glyphicon-plus">товар</i></button>
