...
class ProductsSearch extends Products
{
    ...
    {
        return [
            [['products_id', 'active'], 'integer'],
            [['description_en', 'description_ua', 'part_number', 'country_origin_en', 'country_origin_ua', 'tarif_number_en', 'tarif_number_ua', 'weight', 'height', 'width', 'length', 'created_at'], 'safe'],
            [['price'], 'number'],
        ];
    }
