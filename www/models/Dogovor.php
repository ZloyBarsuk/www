...
class Dogovor extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_bank_executor'], 'exist', 'skipOnError' => true, 'targetClass' => BankToContractor::className(), 'targetAttribute' => ['id_bank_executor' => 'bank_contr_id']],
            [['id_bank_contractor'], 'exist', 'skipOnError' => true, 'targetClass' => BankToContractor::className(), 'targetAttribute' => ['id_bank_contractor' => 'bank_contr_id']],
