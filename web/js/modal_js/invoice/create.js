            ...
            $.ajax({
               ...
               // 'data': data,
                ...
                success: function (data) {
                    ...
                    if (button_id == 'add_invoice_modal') {
                        $.pjax.reload({
                            container: '#dogovor-invoice-grid',
                            push: true,
                            url: grid_data.controller,
                            data: {'dogovor_id': grid_data.dogovor_id},
                            history: false,
                            cache: false,
                            datatype: 'html',
                    ...
                    else if (button_id == 'add_invoice_index') {
                        $.pjax.reload({container: '#dogovor-invoice-grid'});
                    }
